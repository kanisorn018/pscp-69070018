...
```
โจทย์ให้รับชื่อสีพื้นฐาน 2 สี จาก Red Yellow Blue แล้วนำมาผสมกัน หากเป็นสีต่างกันให้แสดงสีที่เกิดจากการผสมเป็นสี Orange Green Violet แต่ถ้าทั้งสองสีเหมือนกันให้แสดงสีนั้นออกมา และถ้ารับค่าสีที่ไม่อยู่ในเงื่อนไขให้แสดง "Error"
...
```
Step 1: รับค่าสี 2 สีจาก input
Step 2: ตรวจสอบการจับคู่ของสีทั้งสองโดยใช้ if และ elif (เช็คตัวอักษร)
Step 3: ถ้าเป็นคู่สีที่ผสมกันได้ให้แสดงสีที่เกิดขึ้น
Step 4: ถ้าสีทั้งสองเหมือนกันให้แสดงสีนั้น
Step 5: หากไม่ตรงกับทุกเงื่อนไขให้แสดง Error
```
...
```
เพื่อเข็คว่าถ้าผสมสีเดียวกันจะได้สีอื่นไหม
```
