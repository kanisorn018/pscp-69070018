...
```
โจทย์ให้ต้องการรับเงินที่มีการคิดค่าบริการ 10% โดยที่ขั้นต่ำคือ 50 สูงสุดึอ 1000 และนำยอดรวมทั้งหมดไปคิดกับ vat 7%  รวมเป้นราคาบิลทั้งหมด
...
```
Step 1: รับค่าเงินจาก input
Step 2: คำนวณค่าบริการ 10% 
Step 3: เช็คว่าค่าบริการน้อยกว่า 50 หรือมากกว่า 1000 ไหมถ้าใช่ทำตามเงื่อนไข
Step 4: นำราคาสินค้าและบริการมารวมกัน
Step 5: คำนวณ VAT 7% จากยอดรวม
Step 6: แสดงยอดเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
เช็ค service ที่อยู่ในช่วง 51 ถึง 999
```
